   ...
   $username="root";
    ...
    if($fail){
      ...
      if($result->num_rows>0){
        ...
        $query = "insert into activity (activity_num,pri_mob_num,_date,school_id,_leave,leave_reason,holiday,holiday_reason,sessions,num_of_sessions) values('".RndString()."','".$pri_mob_num."','".$date."','".$school_id."',1,'".$leave_reason."',0,'',0,0)";
